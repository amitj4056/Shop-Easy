    ...
    public Category(Socket s,DataInputStream din,DataOutputStream dout,String str) throws Exception
    {
       initComponents();
        ...
        if(str.equals("mobile"))
        {
            ...
            categbg.setIcon(new ImageIcon("/home/tushar/NetBeansProjects/FlipZon/images/mob.png"));
        }
        else if(str.equals("fash"))
        {
            dout.writeUTF("fashion");
            categbg.setIcon(new ImageIcon("/home/tushar/NetBeansProjects/FlipZon/images/fash.png"));
        }
        else if(str.equals("elec"))
        {
            dout.writeUTF("electronics");
            categbg.setIcon(new ImageIcon("/home/tushar/NetBeansProjects/FlipZon/images/elec.png"));
        }
        else if(str.equals("food"))
        {
            dout.writeUTF("food");
            categbg.setIcon(new ImageIcon("/home/tushar/NetBeansProjects/FlipZon/images/food.png"));
        }
        else if(str.equals("other"))
        {
            dout.writeUTF("other");
            categbg.setIcon(new ImageIcon("/home/tushar/NetBeansProjects/FlipZon/images/other.png"));
        }
    ...
    class LabelRenderer implements TableCellRenderer
    {
     ...
     public void startClient(int i) throws Exception {
        ...
        Socket so=new Socket(IPtoconnect.ip,4321);
         ...
         im="img"+im+".jpg";
         path="/home/tushar/NetBeansProjects/FlipZon/images"+im;
