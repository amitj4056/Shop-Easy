...
public class Home extends javax.swing.JFrame {
    ...
    public Home(Socket s,DataInputStream din,DataOutputStream dout) throws Exception
    {
        ...
        homeback.setIcon(new ImageIcon("C:\\Users\\hp\\Desktop\\FlipZon\\src\\Image\\home.png")); 
        this.s=s;
    ...
    class LabelRenderer implements TableCellRenderer
    {
     ...
     public void startClient(int i) throws Exception {
         ...
         im="img"+im+".jpg";
         path="C:\\Users\\hp\\Desktop\\FlipZon\\productImages\\"+im;
    ...
    private void mobMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_mobMouseClicked
        ...
        try {
            ...
            homeback.setIcon(new ImageIcon("C:\\Users\\hp\\Desktop\\FlipZon\\images\\mob.png"));
            tm.setRowCount(0);
    ...
    private void elecMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_elecMouseClicked
        ...
        try {
            ...
            homeback.setIcon(new ImageIcon("C:\\Users\\hp\\Desktop\\FlipZon\\images\\elec.png"));
            tm.setRowCount(0);
    ...
    private void foodMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_foodMouseClicked
        ...
        try {
            ...
            homeback.setIcon(new ImageIcon("C:\\Users\\hp\\Desktop\\FlipZon\\images\\food.png"));
            tm.setRowCount(0);
            dout.writeUTF("food");
            this.initcategory();
        }   catch (Exception ex) {
    ...
    private void fashMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_fashMouseClicked
       ...
       try {
            ...
            homeback.setIcon(new ImageIcon("C:\\Users\\hp\\Desktop\\FlipZon\\images\\fash.png"));
            tm.setRowCount(0);
    ...
    private void otherMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_otherMouseClicked
        ...
        try {
            ...
            homeback.setIcon(new ImageIcon("C:\\Users\\hp\\Desktop\\FlipZon\\images\\other.png"));
            tm.setRowCount(0);
            dout.writeUTF("other");
            this.initcategory();
        } catch (Exception ex) {
